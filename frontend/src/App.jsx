/*
# musikconnect tags
purpose: Main React application controlling overall layout and authentication
inputs: browser events, localStorage, API responses
outputs: rendered UI, fetch requests
status: active
depends_on: React, fetchWithAuth, component modules
